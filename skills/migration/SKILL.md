---
name: migration
description: Plan and apply database/schema migrations safely with backup, rollback and verification notes.
---

# Haye Skill: migration

## Purpose
Plan and apply database/schema migrations safely with backup, rollback and verification notes.
