---
name: bugfix
description: Debug with reproduce, root cause, minimal fix, verification and memory update.
---

# Haye Skill: bugfix

## Purpose
Debug with reproduce, root cause, minimal fix, verification and memory update.
