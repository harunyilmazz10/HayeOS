...
**Context:** If working in an isolated worktree, it should have been created via the `haye:using-git-worktrees` skill at execution time.

**Save plans to:** `<resolved memoryPath>/04-plans/YYYY-MM-DD-<feature-name>.md`
...
> **For agentic workers:** REQUIRED SUB-SKILL: Use haye:subagent-driven-development (recommended) or haye:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
**"Plan complete and saved to `<resolved memoryPath>/04-plans/<filename>.md`. Two execution options:**
...
- **REQUIRED SUB-SKILL:** Use haye:subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use haye:executing-plans
