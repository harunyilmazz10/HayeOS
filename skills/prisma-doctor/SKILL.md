---
name: prisma-doctor
description: Diagnose Prisma client, migrations, OpenSSL/libssl, database connectivity and schema problems.
---

# Haye Skill: prisma-doctor

## Purpose
Diagnose Prisma client, migrations, OpenSSL/libssl, database connectivity and schema problems.
