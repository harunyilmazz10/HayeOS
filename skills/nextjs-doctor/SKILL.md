---
name: nextjs-doctor
description: Diagnose Next.js build, routing, App Router, server actions, cache, image and deployment problems.
---

# Haye Skill: nextjs-doctor

## Purpose
Diagnose Next.js build, routing, App Router, server actions, cache, image and deployment problems.
