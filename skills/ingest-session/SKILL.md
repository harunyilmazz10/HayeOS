---
name: ingest-session
description: Summarize raw Claude Code JSONL sessions, terminal logs, old prompts, or notes into structured memory without copying raw content.
---

# Haye Skill: ingest-session

## Purpose
Summarize raw Claude Code JSONL sessions, terminal logs, old prompts, or notes into structured memory without copying raw content.
