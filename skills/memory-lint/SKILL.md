---
name: memory-lint
description: Audit the Obsidian memory vault for stale, bloated, contradictory, missing or orphaned information.
---

# Haye Skill: memory-lint

## Purpose
Audit the Obsidian memory vault for stale, bloated, contradictory, missing or orphaned information.
