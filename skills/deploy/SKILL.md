---
name: deploy
description: Prepare and verify deployment with Docker, Coolify, Cloudflare, env, healthcheck, logs and rollback.
---

# Haye Skill: deploy

## Purpose
Prepare and verify deployment with Docker, Coolify, Cloudflare, env, healthcheck, logs and rollback.
