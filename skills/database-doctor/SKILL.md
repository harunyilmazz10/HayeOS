...
description: Diagnose Postgres/database schema, connection, migrations, backups and exposure risks.
---

# Haye Skill: database-doctor

## Purpose
Diagnose Postgres/database schema, connection, migrations, backups and exposure risks.
