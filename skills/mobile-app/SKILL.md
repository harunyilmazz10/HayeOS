---
name: mobile-app
description: Work on mobile app workflows, app publishing, auth, API compatibility and release notes.
---

# Haye Skill: mobile-app

## Purpose
Work on mobile app workflows, app publishing, auth, API compatibility and release notes.
