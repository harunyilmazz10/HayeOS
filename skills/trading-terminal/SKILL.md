...
description: Work on trading/prediction terminals with risk controls, API adapters, region constraints, logging and safety boundaries.
---

# Haye Skill: trading-terminal

## Purpose
Work on trading/prediction terminals with risk controls, API adapters, region constraints, logging and safety boundaries.
