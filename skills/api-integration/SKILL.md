...
description: Design and implement external API integrations with auth, retries, error handling, rate limits and secrets policy.
---

# Haye Skill: api-integration

## Purpose
Design and implement external API integrations with auth, retries, error handling, rate limits and secrets policy.
