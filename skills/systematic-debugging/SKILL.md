...
1. **Create Failing Test Case**
   ...
   - Use the `haye:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **haye:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **haye:verification-before-completion** - Verify fix worked before claiming success
