---
name: video-factory
description: "Work on AI video factories: source search, OCR/filter, TTS, subtitles, ffmpeg, R2 storage and platform upload."
---

# Haye Skill: video-factory

## Purpose
Work on AI video factories: source search, OCR/filter, TTS, subtitles, ffmpeg, R2 storage and platform upload.
