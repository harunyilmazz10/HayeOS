...
description: Work on manager/worker AI agent systems, approval gates, tool permissions, logs, memory and cost controls.
---

# Haye Skill: ai-agent-system

## Purpose
Work on manager/worker AI agent systems, approval gates, tool permissions, logs, memory and cost controls.
