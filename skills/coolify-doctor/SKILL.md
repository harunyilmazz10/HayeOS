---
name: coolify-doctor
description: Diagnose Coolify deployment, build, proxy, env, volume, healthcheck and container issues.
---

# Haye Skill: coolify-doctor

## Purpose
Diagnose Coolify deployment, build, proxy, env, volume, healthcheck and container issues.
