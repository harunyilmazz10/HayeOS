...
description: Audit exposed ports, firewall assumptions, DB exposure and reverse proxy security.
---

# Haye Skill: exposed-port-audit

## Purpose
Audit exposed ports, firewall assumptions, DB exposure and reverse proxy security.
