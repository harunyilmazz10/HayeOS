---
name: token-audit
description: Find context/token waste and recommend /clear, context packs, session splitting, summary updates and model selection.
---

# Haye Skill: token-audit

## Purpose
Find context/token waste and recommend /clear, context packs, session splitting, summary updates and model selection.
