---
name: project-map
description: "Build or refresh the project map: important files, API map, database, env vars, deployment and external services."
---

# Haye Skill: project-map

## Purpose
Build or refresh the project map: important files, API map, database, env vars, deployment and external services.
