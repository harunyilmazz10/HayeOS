---
name: auth-audit
description: Audit authentication, sessions, cookies, admin guards, API route authorization and role checks.
---

# Haye Skill: auth-audit

## Purpose
Audit authentication, sessions, cookies, admin guards, API route authorization and role checks.
