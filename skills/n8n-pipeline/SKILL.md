---
name: n8n-pipeline
description: Work on n8n automation pipelines with credentials, retries, logging, webhooks and error recovery.
---

# Haye Skill: n8n-pipeline

## Purpose
Work on n8n automation pipelines with credentials, retries, logging, webhooks and error recovery.
