---
name: refactor
description: Refactor safely with behavior preservation, risk tracking, tests and rollback notes.
---

# Haye Skill: refactor

## Purpose
Refactor safely with behavior preservation, risk tracking, tests and rollback notes.
