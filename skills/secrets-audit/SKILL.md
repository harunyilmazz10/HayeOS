---
name: secrets-audit
description: Find possible secret leaks in env files, code, logs, CI settings and memory notes.
---

# Haye Skill: secrets-audit

## Purpose
Find possible secret leaks in env files, code, logs, CI settings and memory notes.
